        ...
        <div className="icons">
            <div className="icon">
                <a href="https://www.linkedin.com/in/roberto-griel-filho/" target="_blank" rel="noreferrer" aria-label="Encontre-me no LinkedIn">
                    <img src="/images/svg/icon-linkedin.svg" aria-label="Encontre-me no LinkedIn" alt="Encontre-me no LinkedIn" />
                </a>
            </div>
            <div className="icon">
                <a href="https://github.com/robertogriel" target="_blank" rel="noreferrer" aria-label="Encontre-me no Github">
                    <img src="/images/svg/icon-github.svg" aria-label="Encontre-me no Github" alt="Encontre-me no Github" />
                </a>
            </div>
