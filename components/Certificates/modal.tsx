...
const Modal = ({
  ...
  certificateImage,
  onClick,
}: CertificateModalToOpenType) => {
  return (
    <ModalOverflow className={certificateName ? "open" : ""}>
      <ModalContainer className={certificateName ? "open" : ""}>
        <div className="modal-body">
          <ModalImage
            src={`/images/certificates/${certificateImage}@1x.jpg`}
            alt={`Certificado ${certificateName}`}
          />
          <ButtonCloseModal
            className="close"
          ...
          <FooterModal>
            <ButtonDownloadModal href={`/images/certificates/${certificateImage}@2x.jpg`} target="_blank">Tamanho original</ButtonDownloadModal>
          </FooterModal>
        </div>
      </ModalContainer>
    </ModalOverflow>
